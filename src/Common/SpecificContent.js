...
export const specificdata = [
  ...
  },
  {
    ...
    content:
      "The best time to enjoy golfing in Pahalgam is between May and October. During these months, the weather in Pahalgam is pleasant, and the golf course is in prime condition. The temperature during the day ranges from 15°C to 25°C, making it perfect for outdoor activities such as golfing.During the summer, the days are longer, and the weather is warmer, making it an ideal time for golfers to enjoy a round of golf. The course is usually less crowded during the weekdays, and golfers can enjoy a peaceful and serene golfing experience.The best time to enjoy golfing in Pahalgam is between May and October. During these months, the weather in Pahalgam is pleasant, and the golf course is in prime condition. The temperature during the day ranges from 15°C to 25°C, making it perfect for outdoor activities such as golfing.During the summer, the days are longer, and the weather is warmer, making it an ideal time for golfers to enjoy a round of golf. The course is usually less crowded during the weekdays, and golfers can enjoy a peaceful and serene golfing experience.",
  },
  {
    place: "Sonmarg",
    placeType:"Domestic",
  ...
  },
  {
    ...
    content2:"Goa’s charm lies in its unique blend of Portuguese heritage and Indian culture. From iconic churches like the Basilica of Bom Jesus to colorful streets lined with cafes, every corner of Goa tells a story. Add in the vibrant nightlife of Tito’s Lane, serene sunsets on the Mandovi River, and the thrill of adventure sports, and you have the ultimate destination for friends, couples, or even solo travelers.",
    itinerary: [
        {
          heading: "Arrival & Beach Vibes",
          text: "Your Goa adventure begins with a warm coastal welcome. After checking in at your hotel, head to Calangute Beach for a relaxing stroll along the sandy shores. As the sun dips below the horizon, unwind at a beach shack with delicious Goan cuisine, chilled drinks, and live music.",
        },
        {
          heading: "Adventure & Exploration",
          text: "Gear up for an action-packed day as you dive into water sports at Baga Beach. From jet skiing to parasailing, the adventures are endless. Post-lunch, explore the historic Fort Aguada and the scenic Sinquerim Beach. In the evening, experience the electrifying nightlife at Tito’s Lane, where music, lights, and energy combine to create an unforgettable party scene.",
        },
        {
          heading: "Culture & Serenity",
          text: "Start your day with a touch of culture as you visit the Basilica of Bom Jesus and Se Cathedral, both UNESCO World Heritage Sites that exude architectural brilliance. Spend the afternoon at Palolem Beach, soaking in its tranquil vibes and picturesque views. End your day with a sunset cruise on the Mandovi River, complete with live music and spectacular views.",
        },
        {
            heading: "Shopping & Departure",
            text: "Before you bid goodbye to Goa, indulge in some retail therapy at the vibrant Anjuna Flea Market. Pick up souvenirs, jewelry, and handicrafts to remember your trip. Relax at your resort and soak in the final moments of this coastal haven before heading back home.",
          },
      ],
  },

  {
    ...
    content:
      "Nestled at the foothills of the majestic Himalayas, Rishikesh is more than just a destination—it's an experience that resonates with every traveler’s soul. Revered as the “Yoga Capital of the World,” Rishikesh is a harmonious blend of serene spirituality and adrenaline-pumping adventure. Whether you’re meditating by the sacred Ganges or riding the rapids of its wild waters, Rishikesh has something unique to offer every traveler.",
    content2:
      "This holy city boasts a rich history and culture, attracting spiritual seekers, nature enthusiasts, and adventure lovers from around the globe. The iconic suspension bridges—Laxman Jhula and Ram Jhula—are not just architectural marvels but symbols of the city’s enduring charm. Adding to the allure are serene ashrams, breathtaking waterfalls, and tranquil caves, making Rishikesh a haven for those seeking solace and thrill alike.",
    itinerary: [
      {
        heading: "Arrive and Embrace the Spiritual Aura",
        text: "Kick off your Rishikesh adventure with a peaceful start. Check in at your hotel and soak in the tranquil vibes of this spiritual haven. Later, head to the serene Triveni Ghat for a calming experience by the sacred Ganges. Don’t miss the enchanting Ganga Aarti in the evening",
      },
      {
        heading: "Dive into Adventure and Exploration",
        text: "Wake up to a day packed with excitement and discovery. Start with an exhilarating session of white-water rafting on the Ganges, navigating through family-friendly rapids. Later, explore the iconic Laxman Jhula and Ram Jhula, marveling at their engineering and historical significance",
      },
      {
        heading: " Seek Divine Blessings and Reflect",
        text: "Begin your final day with a rejuvenating yoga session by the Ganges, soaking in the spiritual essence of Rishikesh. Visit Parmarth Niketan Ashram for blessings and tranquility. Conclude your trip with a visit to the peaceful Vashishta Cave, a perfect spot for quiet reflection before heading back home with a heart full of cherished memories.",
      },
    ],
  },

  {
    ...
    content:
    "Nestled amidst the verdant Khasi Hills, Shillong is often called the Scotland of the East for its lush greenery and rolling hills. The city boasts a perfect mix of natural beauty and cultural richness, making it a traveler’s paradise. From the pristine waters of Dawki’s Umngot River to the awe-inspiring Living Root Bridges of Mawlynnong, every corner of Shillong promises breathtaking views and serene moments.",
    content2:
      "Shillong’s charm lies in its lively markets, vibrant cafes, and rich tribal heritage. Add to that the misty Laitlum Canyons, cascading waterfalls, and legendary caves, and it’s easy to see why this destination is a must-visit for anyone seeking tranquility, adventure, or cultural exploration.",
    itinerary: [
      {
        heading: "Welcome to paradise",
        text: "Arrive in Shillong and begin your journey with a scenic drive from Guwahati. On the way, stop at the mesmerizing Umiam Lake for stunning views and photo ops. In the evening, dive into the bustling energy of Police Bazaar, Shillong’s cultural and shopping hub. End the day with a cozy stay in a charming hotel.",
      },
      {
        heading: "Unveil Shillong’s Treasures",
        text: "Start your morning with a romantic boat ride at Ward’s Lake, followed by a visit to the iconic Don Bosco Museum—a seven-story treasure trove of Northeast heritage. Head to Shillong Peak for panoramic views and Elephant Falls for nature’s splendor. Spend your evening savoring local delicacies or exploring Shillong’s café culture.",
      },
      {
        heading: "Mawlynnong & Dawki – Nature’s Masterpieces",
        text: "Embark on a journey to Mawlynnong, Asia’s cleanest village, and walk across the magical Living Root Bridge. Continue to Dawki to glide on the glass-like waters of the Umngot River. By evening, return to Shillong, carrying memories of these natural wonders.",
      },
      {
        heading: "Cherrapunji – Land of Legends",
        text: "Discover Cherrapunji’s unparalleled beauty with visits to Nohkalikai Falls, Mawsmai Caves, and Seven Sisters Falls. Marvel at the wonders of rain and nature in this legendary destination. Return to Shillong in the evening for a relaxed night.",
      },
      {
        heading: "Laitlum Canyons & Hidden Gems",
        text: "Start your day at the serene Laitlum Canyons, where clouds meet the earth. Visit the tranquil Sweet Falls and the quaint Lady Hydari Park in the afternoon. Wrap up your day with reflections on your journey or enjoy a lively bonfire with your group.",
      },
      {
        heading: "Farewell with a Smile",
        text: "Enjoy your final breakfast in Shillong before transferring to Guwahati. Make an optional stop at the revered Kamakhya Temple to seek blessings. Leave with unforgettable memories of this magical escape.",
      },
    ],
  },
