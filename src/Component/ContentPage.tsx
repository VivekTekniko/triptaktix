...
const ContentPage = () => {
  return (
    <section className=" bg-slate-100">
      ...
      <div className="max-w-screen-lg md:m-auto mx-6" >
        <div >
        ...
        <div >
          <h2 className="text-3xl font-cursive py-4 text-web font-bold">
          MICE Services and Corporate Travel in Ghaziabad
          </h2>
          <p className="text-2xl text-gray-600 font-semibold py-4">
          At TripTactix, we specialize in MICE services in Ghaziabad (Meetings, Incentives, Conferences, and Events) to cater to all your corporate travel needs. Our corporate travel services include event planning, team-building trips, and more. From conferences to business retreats, we deliver exceptional service with precision and professionalism.          </p>
        </div>
        <div >
          <h2 className="text-3xl font-cursive py-4 text-web font-bold">
        ...
        <div >
          <h2 className="text-3xl font-cursive py-4 text-web font-bold">
          Hassle-Free Flight and Hotel Booking Services
          </h2>
          <p className="text-2xl text-gray-600 font-semibold py-4">
          TripTactix takes the hassle out of travel with our flight booking services and hotel bookings in Ghaziabad. Whether you need a last-minute getaway or a long vacation, we get you the best deals. We also offer Dubai visa assistance, making international travel a breeze.          </p>
        </div>
        <div >
          <h2 className="text-3xl font-cursive py-4 text-web font-bold">
          Adventure Tourism and Family Vacation Packages
          </h2>
          <p className="text-2xl text-gray-600 font-semibold py-4">
          For adventure enthusiasts, TripTactix provides exciting adventure tourism in Ghaziabad, including trekking, safaris, and water sports. For families, our family vacation packages create cherished memories. Couples can enjoy exclusive honeymoon packages in Ghaziabad for the perfect romantic escape.          </p>
        </div>
