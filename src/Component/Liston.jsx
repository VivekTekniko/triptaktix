    ...
    //     </div>
                ...
                <div className='grid grid-cols-2 gap-4'>
                    <div className='shadow-lg  rounded-xl '>
                        <div className=''>
                            <img src={mot.src} className='m-auto p-6 w-48' />
                            <p className='text-lg p-2 pt-0 text-white text-center font-medium'>&quot;Certified by the Ministry of Tourism, India.&quot;</p>
                        </div>
                    </div>
                    <div className='shadow-lg  rounded-xl '>
                        <div>
                            <img src={adtoi.src} className='m-auto p-6 w-48' />
                            <p className='text-lg p-2pt-0 text-white text-center font-medium'>&quot;Member of the Association of Domestic Tour Operators of India (ADTOI).&quot;</p>
                        </div>
                    </div>
            </div>
    )
